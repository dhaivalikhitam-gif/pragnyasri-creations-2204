  ...
  const syncWithGithubCloud = async (overrideGist?: string, overrideToken?: string) => {
    ...
    try {
      const payload = {
        ...
        files: {
          "pragnyasri_creations_2204_db.json": {
                                ...
                                printWindow.document.write(`
                                  ...
                                  <body>
                                    <div class="wrapper">
                                      ...
                                      <ol>
                                        <li><strong>Setup Cloud Store:</strong> Visit Gist on GitHub and create a file with name <code>pragnyasri_creations_2204_db.json</code>.</li>
