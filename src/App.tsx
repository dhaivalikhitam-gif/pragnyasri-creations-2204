...
export default function App() {
  ...
  const [settings, setSettings] = useState<BrandingSettings>(() => {
    ...
    return {
      ...
      about2: "From grand wedding celebrations to intimate baby shoots, our team is dedicated to delivering professional quality that you will cherish for a lifetime.",
    ...
    const fetchCloudData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const fileContent = gistData.files && gistData.files["pragnyasri_creations_2204_db.json"]?.content;
          if (fileContent) {
  ...
  const triggerCopy = () => {
    ...
    triggerToast("Portfolio link copied to clipboard!");
  };
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    // Create WhatsApp Session payload
    ...
    setToastMessage("Booking request sent! Opening WhatsApp...");
    setShowToast(true);
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    setToastMessage("Thank you! Our creative team member will connect with you within 24 hours.");
    setShowToast(true);
        ...
        {loading && (
          ...
          >
            <div className="text-center px-6">
              ...
              <p className="font-serif text-sm text-[#d4b483] italic uppercase tracking-[0.2em] font-light mb-8">
                CREATIONS
              </p>
              ...
              <div className="w-48 max-w-xs h-[1px] bg-[#222] mx-auto rounded-full overflow-hidden relative mb-2">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-[#b8965a] to-[#d4b483]"
                />
              </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div 
            ...
            className="flex flex-wrap items-center justify-center gap-2 mb-12 max-w-4xl mx-auto border-b border-white/5 pb-4"
          >
            {[
              { id: "all", label: "All" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              >
                ...
                <div className="absolute -top-10 -left-10 h-32 w-32 bg-gradient-to-tr from-[#b8965a]/10 to-transparent blur-2xl rounded-full" />
                <div className="absolute -bottom-10 -right-10 h-32 w-32 bg-gradient-to-tr from-[#b8965a]/5 to-transparent blur-3xl rounded-full" />
              </div>
            </div>
...
function AIChatbot({ settings, services }: { settings: any; services: any[] }) {
  ...
  const servicesList = services.map((s: any) => `${s.title}: ${s.desc}`).join("\n");
...
Answer questions about services, pricing (say "please contact us for pricing"), availability, and location. Be friendly, concise, and professional. If asked something unrelated, politely redirect to studio topics.`;
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const reply = data.content?.[0]?.text || "Sorry, I could not understand that. Please contact us directly!";
